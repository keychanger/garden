...
export const resolveStepsSection: PromptSection = {
  ...
  render(ctx) {
    return [
      ...
      "   rebase drops the merge and replays every commit from the merged-in side against a tree",
      "   that already has their content, which produces conflicts that cannot be resolved.",
      "",
