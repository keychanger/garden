...
6. **merged**: Code merged to the base branch. Transitions back to working when the user re-engages (Claude becomes active) or new commits appear, starting a new review cycle.
