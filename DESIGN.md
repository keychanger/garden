...
- **Usage Meters** (top-left) — Dedicated pane (fixed 5 rows) showing three Claude quota bars: the 5-hour rolling window, the weekly total, and the Sonnet-specific weekly meter. Refreshed via SIGUSR1 from a pre-baked `usage.rendered` file.
